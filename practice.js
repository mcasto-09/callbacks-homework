...
let evens = (array) => array.filter((num) => num % 2 === 0);
...
let startWithLetterA = (array) => array.filter((str) => str[0].toLowerCase() === 'a')
...
let productOfArray = (numbers) => {
  return numbers.reduce((notcurrent, current) => notcurrent *current);
}
